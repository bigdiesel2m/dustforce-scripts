...
class Kid : Protest, trigger_base {
	...
	void draw_it() {
		if (bg_visible) {
			...
			spr2.draw_world(layer, 21, "backdrops_6", 0, 0, self.x(), self.y()-56 + yoffset, 0.0, 0.5, 0.25, 0xFFFFFFFF);
...
class Worth : Protest, trigger_base {
	...
	void draw_it() {
		if (bg_visible) {
			...
			spr2.draw_world(layer, 21, "backdrops_6", 0, 0, self.x()-15, self.y()-120 + yoffset, 0.0, 0.4, 0.5, 0xFFFFFFFF);
